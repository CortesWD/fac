...
<link link href="https://fonts.googleapis.com/css?family=Lato:300,400,700|Titillium+Web:400,700" rel="stylesheet">
</head>
<body class="<?php print $classes; print ' '.variable_get('clase_template'); ?>"<?php print $attributes; ?>>
