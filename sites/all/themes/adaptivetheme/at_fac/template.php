...
function at_fac_preprocess_page(&$vars) {
	drupal_add_css(drupal_get_path('theme', 'at_fac') . '/css/intranet-fac.min.css');
	drupal_add_js(drupal_get_path('theme', 'at_fac').'/css/js/libs/modernizr-2.6.2.min.js');

	drupal_add_js(drupal_get_path('theme', 'at_fac').'/css/js/libs.min.js');
	drupal_add_js(drupal_get_path('theme', 'at_fac').'/css/js/intranet-fac.init.js');
	
}
function at_fac_process_page(&$vars) {
}
// */
